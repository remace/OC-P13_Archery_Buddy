...
class Barebow(Bow):
    ...
    string = models.ForeignKey(
        "alternativeequipment.EquipmentString",
        verbose_name="corde",
        on_delete=models.CASCADE,
    )
    arrow_rest = models.ForeignKey(
        "alternativeequipment.ArrowRest",
        verbose_name="repose_flèche",
        on_delete=models.CASCADE,
    )
    berger_button = models.ForeignKey(
        "alternativeequipment.BergerButton",
        verbose_name="Berger",
        on_delete=models.CASCADE,
    )
...
class OlympicBow(Bow):
    ...
    barebow = models.ForeignKey(
        "alternativeequipment.Barebow", on_delete=models.CASCADE
    )
    scope = models.ForeignKey("alternativeequipment.Scope", on_delete=models.CASCADE)
    clicker = models.ForeignKey(
        "alternativeequipment.Clicker", on_delete=models.CASCADE
    )
    stabilisation = models.ForeignKey(
        "alternativeequipment.stabilisation", on_delete=models.CASCADE
    )
    dampeners = models.ForeignKey(
        "alternativeequipment.Dampeners", on_delete=models.CASCADE
    )
...
class CompoundBow(Bow):
    ...
    arrow_rest = models.ForeignKey(
        "alternativeequipment.CompoundArrowRest",
        verbose_name="repose_flèche",
        on_delete=models.CASCADE,
    )
    stabilisation = models.ForeignKey(
        "alternativeequipment.Stabilisation",
        verbose_name="stabilisation",
        on_delete=models.CASCADE,
    )
    dampeners = models.ForeignKey(
